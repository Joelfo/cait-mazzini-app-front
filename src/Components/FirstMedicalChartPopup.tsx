...
export type FirstMedicalAppointmentChartPopupProps = {
    show: boolean,
    chart: FirstMedicalAppointmentChart;
    onClose: () => void;
}

export const FirstMedicalAppointmentChartPopup = ({ show, chart, onClose } : FirstMedicalAppointmentChartPopupProps) => {
                        ...
                        <Row className='justify-content-start tracking-chart-row'>
                            <Col md='10'>
                                <Stack>
                                    ...
                                    <ReactQuill
                                        style={{minHeight: 'auto'}}
                                        value={chart?.requestLaboratoryExams}
                                        readOnly={true}
                                        theme={'bubble'}
                                    />
